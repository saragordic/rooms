...
- **Keep one window fixed.** Open the Rooms menu while the window is frontmost and choose **Pin [window] Here**. Rooms keeps that window in the same relative place whenever it appears in a room, and arranges the others around it. Choose **Unpin** from the same menu to remove it.
